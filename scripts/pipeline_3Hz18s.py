...
input_fn = '/datax/scratch/bbrzycki/data/blc00_guppi_58331_12383_DIAG_SGR_B2_0014.gpuspec.0000.fil'
output_dir = '/datax/scratch/bbrzycki/data/3Hz18s_turbo_hits/'
...
split_fns = glob.glob('/datax/scratch/bbrzycki/data/3Hz18s_turbo_hits/*.fil')
...
handler = logging.FileHandler('/datax/scratch/bbrzycki/data/3Hz18s_turbo_hits/10.log')
...
# create a file handler
handler = logging.FileHandler('/datax/scratch/bbrzycki/data/3Hz18s_turbo_hits/100.log')
handler.setLevel(logging.INFO)
