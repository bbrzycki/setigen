...
def generate(ts,
             ...
             bp_profile):
    """
    Generates synthetic signal based on given path in time-frequency domain \
    and brightness profiles in time and frequency directions.
    ...
    Return:
        signal, two-dimensional NumPy array that only contains synthetic \
            signal data
    """
